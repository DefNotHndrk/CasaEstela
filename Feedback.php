            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%" id="rooms">
                        ...
                        <tbody>
                        <?php
                        $complaint_query = "SELECT * FROM feedback";
                        ...
                        if (mysqli_num_rows($complaint_result) > 0) {
                            ...
                            while ($complaint = mysqli_fetch_assoc($complaint_result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $complaint['feedback_type'] ?></td>
                                    <td><?php echo $complaint['feedback'] ?></td>
                                    ...
                                    <th><?php echo $complaint['remarks'] ?></th>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Feedback Resolve</h4>
                </div>
                        ...
                        <div class="col-lg-12">
                            <form data-toggle="validator" role="form" method="post" action="ajax.php">
                                <div class="form-group">
                                    <label></label>
                                    <input class="form-control" placeholder="Remark" name="budget" data-error="Enter Remarks" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <input type="hidden" id="complaint_id" name="complaint_id" value="">
                                <button class="btn btn-success pull-right" name="resolve_complaint">Send Remarks</button>
                            </form>
                        </div>
                    </div>
                </div>
